...
<body>
        ...
        <div>
            <nav class="nav-bar">
                ...
                <button><a href = "3" >Log out</a></button>
            </nav>
        </div>
        ...
        <div class="container">
            <div class="main">
                <div class="content">
                    ...
                    $mysql_user = $_POST["text1"];
                    $mysql_password = $_POST["text2"];
                    // echo $mysql_user." ".$mysql_password;

                    $sqlvar = "select * from `logintab` where userId ='$mysql_user' and pWord= '$mysql_password'";
                    ...
                    <form action="adminlogin.php" method="post">
                        ...
                        <button class="btn" name = "login" type="submit"><a href="#">Log In</a></button>
                    </form>
                </div>
